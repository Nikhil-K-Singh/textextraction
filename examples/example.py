...
def process_with_tesseract():
    ...
    image_processor.process_image(
        image_path="/Users/nikhilsingh/Documents/img_table.jpg",
        output_path="output_image_tesseract_table.md",
        filter_words=False,
    )
    ...
    scanned_pdf_processor.process_pdf(
        pdf_path="/Users/nikhilsingh/Documents/pdf_table.pdf",
        output_path="output_scanned_tesseract_table.md",
        filter_words=False,
    )
...
def process_with_easyocr():
    ...
    image_processor.process_image(
        image_path="/Users/nikhilsingh/Documents/img_table.jpg",
        output_path="output_image_easyocr_table.md",
        filter_words=False,
    )
    ...
    scanned_pdf_processor.process_pdf(
        pdf_path="/Users/nikhilsingh/Documents/pdf_table.pdf",
        output_path="output_scanned_easyocr_table.md",
        filter_words=False,
    )
...
def process_regular_pdf():
    ...
    pdf_processor.process_pdf(
        pdf_path="/Users/nikhilsingh/Documents/pdf_table.pdf",
        output_path="output_pdf_table.md",
        filter_words=False,
    )

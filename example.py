...
def process_with_tesseract():
    ...
    image_processor.process_image(
        image_path="/Users/nikhilsingh/Documents/check.png",
    ...
    scanned_pdf_processor.process_pdf(
        pdf_path="/Users/nikhilsingh/Downloads/PublicWaterMassMailing.pdf",
...
def process_regular_pdf():
    ...
    pdf_processor.process_pdf(
        pdf_path="/Users/nikhilsingh/Downloads/sample.pdf",
